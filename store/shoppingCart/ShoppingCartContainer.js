...
class ShoppingCartContainer{
  ...
  addProduct(shoppingCartProduct,callback = function(){},bool){  

    shoppingCartProduct.getShopInfo().then((shopInfo) => {
      console.log(shopInfo);
      let shopShoppingCart = this.getOrCreateShopShoppingCart(shopInfo);
      console.log("===========",shopShoppingCart);
      shopShoppingCart.addProduct(shoppingCartProduct, bool);     
      callback()
    })      
  }
